...
export default function WidgetMeteo({ defaultCity }) {
  ...
  useEffect(() => {
    ...
    axios.get(`${apiBaseUrl}?q=${city}&units=metric&lang=fr&appid=${apiKey}`)
      .then(res => {
  ...
  return (
    <div className="widget-meteo">
      ...
      <p className="widget-meteo__temperature">{temperature}°C</p>
